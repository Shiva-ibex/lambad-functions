...
## This function deletes the snapshots based on given retention period both at source region and destination region

## It deletes the snapshots based on creation time criteria
